...
const ProfileScreen: React.FC = () => {
  ...
  const handleDeleteBuild = async (buildId: string) => {
    try {
      console.log(buildId);
      const res = await axios.delete(API_URL + `/build/${buildId}`);
      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={styles.profileSection}>
          ...
          <View style={styles.userInfo}>
            ...
            {/* <Text style={styles.userJoinDate}>Member since {user?.createdAt.toString()}</Text> */}
          </View>
            ...
            builds.map((build) => (
              <View key={build.id} style={styles.buildCard}>
                ...
                <View style={styles.buildActions}>
                  <TouchableOpacity
                    style={styles.buildActionButton}
                    onPress={() => handleViewBuild(build.id)}>
